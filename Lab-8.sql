...
SELECT [YEAR],[PRODUCT],SUM(SALES_AMOUNT) AS TOTAL_SALARY
FROM SALES_DATA
GROUP BY [YEAR] , [PRODUCT]

--7. Display Regions with Total Sales Greater Than 5000.

SELECT SUM(SALES_AMOUNT) AS TOTAL_SALARY 
FROM SALES_DATA
GROUP BY REGION
...
SELECT REGION, PRODUCT, COUNT(*) AS DUPLICATES
FROM SALES_DATA
...
SELECT YEAR, PRODUCT, COUNT(*) AS DUPLICATES
FROM SALES_DATA
GROUP BY YEAR, PRODUCT
HAVING COUNT(*) > 1;