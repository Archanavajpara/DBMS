...
SELECT CNAME,CITY INTO EMPLOYEE_DATA FROM EMPLOYEE
WHERE 1=2
...
UPDATE BORROW SET
AMOUNT=1.1*AMOUNT--(100+10/100=1.1)
...
UPDATE BORROW SET
AMOUNT=5000 , BNAME='VRCE' , CNAME='DARSHAN'
WHERE LOANNO=481
